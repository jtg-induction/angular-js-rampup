export default [
  ...
  "localStorageService",
  "apiConstants",
  function ($scope, articleService, localStorageService, apiConstants) {
    ...
    $scope.handlePageChange = (pageValue) => {
      $scope.articleQueryParams.offset =
        apiConstants.ARTICLE_LIMIT * (pageValue - 1);

      articleService
        .getArticles($scope.articleQueryParams)
